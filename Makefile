...
PARSING = $(addprefix parsing/, check_args.c check_file.c check_map.c check_textures.c initialize_textures_paths.c check_file_chars.c initialize_colors.c check_colors.c)
RENDER = 
GAMEPLAY = 
